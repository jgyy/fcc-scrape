...
<head>
  ...
  <title>Learn How JavaScript Assertions Work</title>
  <style>
    html {
      line-height: 1.5;
...
<h1 class="title">Learn How JavaScript Assertions Work</h1>
</header>
...
<span id="cb1-2"><a href="#cb1-2" aria-hidden="true" tabindex="-1"></a>  $<span class="op">.</span><span class="fu">get</span>(<span class="fu">getUserInput</span>(<span class="st">&#39;url&#39;</span>) <span class="op">+</span> <span class="st">&#39;/_api/get-tests?type=unit&amp;n=0&#39;</span>)<span class="op">.</span><span class="fu">then</span>(</span>
...
<p>You should choose the correct method for the first assertion - <code>isNull</code> vs. <code>isNotNull</code>.</p>
...
<span id="cb2-2"><a href="#cb2-2" aria-hidden="true" tabindex="-1"></a>  $<span class="op">.</span><span class="fu">get</span>(<span class="fu">getUserInput</span>(<span class="st">&#39;url&#39;</span>) <span class="op">+</span> <span class="st">&#39;/_api/get-tests?type=unit&amp;n=0&#39;</span>)<span class="op">.</span><span class="fu">then</span>(</span>
<span id="cb2-3"><a href="#cb2-3" aria-hidden="true" tabindex="-1"></a>    (data) <span class="kw">=&gt;</span> {</span>
<span id="cb2-4"><a href="#cb2-4" aria-hidden="true" tabindex="-1"></a>      assert<span class="op">.</span><span class="fu">equal</span>(data<span class="op">.</span><span class="at">assertions</span>[<span class="dv">0</span>]<span class="op">.</span><span class="at">method</span><span class="op">,</span> <span class="st">&#39;isNull&#39;</span><span class="op">,</span> <span class="st">&#39;Null is null&#39;</span>)<span class="op">;</span></span>
...
<p>You should choose the correct method for the second assertion - <code>isNull</code> vs. <code>isNotNull</code>.</p>
...
<span id="cb3-2"><a href="#cb3-2" aria-hidden="true" tabindex="-1"></a>  $<span class="op">.</span><span class="fu">get</span>(<span class="fu">getUserInput</span>(<span class="st">&#39;url&#39;</span>) <span class="op">+</span> <span class="st">&#39;/_api/get-tests?type=unit&amp;n=0&#39;</span>)<span class="op">.</span><span class="fu">then</span>(</span>
<span id="cb3-3"><a href="#cb3-3" aria-hidden="true" tabindex="-1"></a>    (data) <span class="kw">=&gt;</span> {</span>
<span id="cb3-4"><a href="#cb3-4" aria-hidden="true" tabindex="-1"></a>      assert<span class="op">.</span><span class="fu">equal</span>(data<span class="op">.</span><span class="at">assertions</span>[<span class="dv">1</span>]<span class="op">.</span><span class="at">method</span><span class="op">,</span> <span class="st">&#39;isNotNull&#39;</span><span class="op">,</span> <span class="st">&#39;1 is not null&#39;</span>)<span class="op">;</span></span>
