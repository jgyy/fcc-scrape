...
```sh
pandoc placeholder.md -f markdown -t html -s -o ".\05-apis-and-microservices\managing-packages-with-npm\part-001.html"; git add .; git commit -am "part-001.html"; git push origin main;
```
