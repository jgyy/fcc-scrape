...
```sh
pandoc placeholder.md -f markdown -t html -s -o ".\04-data-visualization\json-apis-and-ajax\part-001.html"; git add .; git commit -am "part-001.html"; git push origin main;
```
