...
```sh
pandoc placeholder.md -f markdown -t html -s -o ".\09-information-security\python-for-penetration-testing\part-001.html"; git add .; git commit -am "part-001.html"; git push origin main;
```
