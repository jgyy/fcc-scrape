...
```sh
pandoc placeholder.md -f markdown -t html -s -o ".\07-scientific-computing-with-python\python-for-everybody\part-001.html"; git add .; git commit -am "part-001.html"; git push origin main;
```
