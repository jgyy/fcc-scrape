...
```sh
pandoc placeholder.md -f markdown -t html -s -o ".\06-quality-assurance\advanced-node-and-express\part-001.html"; git add .; git commit -am "part-001.html"; git push origin main;
```
