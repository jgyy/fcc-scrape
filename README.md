...
```sh
pandoc placeholder.md -f markdown -t html -s -o ".\08-data-analysis-with-python\data-analysis-with-python-projects\part-001.html"; git add .; git commit -am "part-001.html"; git push origin main;
```
