...
```sh
pandoc placeholder.md -f markdown -t html -s -o ".\04-data-visualization\data-visualization-with-d3\part-001.html"; git add .; git commit -am "part-001.html"; git push origin main;
```
