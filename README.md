...
```sh
pandoc placeholder.md -f markdown -t html -s -o .\02-javascript-algorithms-and-data-structures\basic-algorithm-scripting\part-001.html; git add .; git commit -am "part-001.html"; git push origin main;
```
