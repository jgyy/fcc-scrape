...
```sh
pandoc placeholder.md -f markdown -t html -s -o ".\10-coding-interview-prep\algorithms\part-001.html"; git add .; git commit -am "part-001.html"; git push origin main;
```
