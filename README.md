...
```sh
pandoc placeholder.md -f markdown -t html -s -o .\01-responsive-web-design\basic-html-cat-photo-app\part-001.html; git add .; git commit -am "part-001.html"; git push origin main;
```
